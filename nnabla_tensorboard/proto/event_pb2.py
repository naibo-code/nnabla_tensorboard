...
# source: nnabla_tensorboard/proto/event.proto
...
_EVENT.fields_by_name['summary'].message_type = nnabla__tensorboard_dot_proto_dot_summary__pb2._SUMMARY
...
Event = _reflection.GeneratedProtocolMessageType('Event', (_message.Message,), dict(
  DESCRIPTOR = _EVENT,
  __module__ = 'nnabla_tensorboard.proto.event_pb2'
