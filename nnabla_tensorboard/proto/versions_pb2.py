...
# source: nnabla_tensorboard/proto/versions.proto
...
VersionDef = _reflection.GeneratedProtocolMessageType('VersionDef', (_message.Message,), dict(
  ...
  __module__ = 'nnabla_tensorboard.proto.versions_pb2'
